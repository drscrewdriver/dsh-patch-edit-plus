...
function isPolicyFace(value: unknown): value is SandboxPolicyFace {
 ...
 */
export function resolveSandboxPolicyService(ctx: Context): SandboxPolicyFace | undefined {
  try {
 ...
 */
export function resolveSandboxPolicy(ctx: Context, exec: ToolRunContext): SandboxExecutionPolicy | undefined {
